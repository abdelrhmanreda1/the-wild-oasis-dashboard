...
`;
const StyleHasBreak = styled.span`
  display: flex;
  @media (max-width: 768px) {
    display: block;
    font-size: 1.3rem;
      ...
      <Section>
        ...
        <Price isPaid={isPaid}>
          <DataItem icon={<HiOutlineCurrencyDollar />} label={`Total price`}>
            ...
            <StyleHasBreak>{hasBreakfast && ` (${formatCurrency(cabinPrice)} cabin + ${formatCurrency(extrasPrice)} breakfast)`}</StyleHasBreak>
          </DataItem>

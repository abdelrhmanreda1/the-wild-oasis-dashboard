...
function CreateCabinForm({ cabinToEdit = {}, onCloseModal }) {
  ...
  return (
    <Form disabled={isWorking} onSubmit={handleSubmit(onSubmit, onError)} type={onCloseModal ? "modal" : "regular"}>
      <FormRow>
      ...
      <FormRow>
        ...
        <Textarea type="number" id="description" defaultValue="" {...register("discription", { required: "this field is required" })} />
      ...
      <FormRow>
        ...
        <Button variations="secondary" sizes="small" type="reset" onClick={() => onCloseModal?.()}>
          Cancel
        </Button>
